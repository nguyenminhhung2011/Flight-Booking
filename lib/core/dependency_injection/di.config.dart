...
import '../../data/repositories/user_repository_impl.dart' as _i47;
...
import '../../domain/usecase/user_usecase.dart' as _i48;
...
import '../../presentations/add_edit_flight/bloc/add_edit_flight_bloc.dart'
    as _i51;
import '../../presentations/airport/bloc/airport_bloc.dart' as _i52;
...
import '../../presentations/flight_detail/bloc/flight_detail_bloc.dart' as _i39;
import '../../presentations/handle_config_airport/blocs/handle_config_airport_bloc.dart'
    as _i40;
import '../../presentations/list_flight/bloc/list_flight_bloc.dart' as _i41;
import '../../presentations/list_ticket/bloc/list_ticket_bloc.dart' as _i42;
import '../../presentations/login/bloc/authentication_bloc.dart' as _i55;
...
import '../../presentations_mobile/airport_detail_mobile/bloc/airport_detail_mobile_bloc.dart'
    as _i3;
import '../../presentations_mobile/auth/bloc/auth_bloc.dart' as _i54;
...
_i1.GetIt init(
  ...
  gh.factory<_i26.TicketRepository>(
      () => _i27.TicketRepositoryImpl(gh<_i24.TicketApi>()));
  ...
  gh.factoryParam<_i39.FlightDetailBloc, int, dynamic>((
    flightId,
    _,
  ) =>
      _i39.FlightDetailBloc(
        flightId,
        gh<_i16.FlightsUsecase>(),
      ));
  gh.factoryParam<_i40.HandleConfigAirportBloc, int, dynamic>((
    airportId,
    _,
  ) =>
      _i40.HandleConfigAirportBloc(
        airportId,
        gh<_i36.AirportUsecase>(),
        gh<_i16.FlightsUsecase>(),
      ));
  gh.factory<_i41.ListFlightBloc>(() => _i41.ListFlightBloc(
        gh<_i16.FlightsUsecase>(),
        gh<_i20.PlaceService>(),
        gh<_i32.AirlineUsecase>(),
      ));
  gh.factory<_i42.ListTicketBloc>(
      () => _i42.ListTicketBloc(gh<_i28.TicketUsecase>()));
  ...
  gh.factory<_i45.TicMobileBloc>(
      () => _i45.TicMobileBloc(gh<_i28.TicketUsecase>()));
  gh.factory<_i46.UserRepository>(
      () => _i47.UserRepositoryImpl(gh<_i37.AuthApi>()));
  gh.factory<_i48.UserUseCase>(
      () => _i48.UserUseCase(gh<_i46.UserRepository>()));
  gh.factory<_i49.AccountSettingBloc>(
      () => _i49.AccountSettingBloc(gh<_i48.UserUseCase>()));
  gh.factoryParam<_i50.AddEditAirportBloc, String, dynamic>((
    airportId,
    _,
  ) =>
      _i50.AddEditAirportBloc(
        airportId,
        gh<_i36.AirportUsecase>(),
  ...
  gh.factoryParam<_i51.AddEditFlightBloc, String, dynamic>((
    flightId,
    _,
  ) =>
      _i51.AddEditFlightBloc(
        flightId,
        gh<_i16.FlightsUsecase>(),
        gh<_i36.AirportUsecase>(),
        gh<_i32.AirlineUsecase>(),
      ));
  gh.factory<_i52.AirportBloc>(() => _i52.AirportBloc(
        gh<_i36.AirportUsecase>(),
        gh<_i16.FlightsUsecase>(),
      ));
  gh.factory<_i53.AirportMobileBloc>(
      () => _i53.AirportMobileBloc(gh<_i36.AirportUsecase>()));
  gh.factory<_i54.AuthBloc>(() => _i54.AuthBloc(gh<_i46.UserRepository>()));
  gh.factory<_i55.AuthenticationBloc>(
      () => _i55.AuthenticationBloc(gh<_i48.UserUseCase>()));
  gh.factory<_i56.GeneralSettingBloc>(
      () => _i56.GeneralSettingBloc(gh<_i48.UserUseCase>()));
  return getIt;
}
