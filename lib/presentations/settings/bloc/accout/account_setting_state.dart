...
class AccountSettingState with _$AccountSettingState {
  ...
  const factory AccountSettingState.addingUser(
      {required AccountSettingModelState data}) = _AddingUser;
  ...
  const factory AccountSettingState.addNewUserSuccess(
      {required AccountSettingModelState data}) = _AddNewUserSuccess;
  const factory AccountSettingState.addNewUserFailed(
      {required AccountSettingModelState data,
      required String message}) = _AddNewUserFailed;
  ...
  bool get isAddingUser => this is _AddingUser;
}
