...
class _PaymentByCardTabState extends State<PaymentByCardTab> {
  ...
  void initState() {
    super.initState();
    _paymentNumber.text = _customer?.creditCard.creditNum ?? '';
    _nameOnPayment.text = _customer?.creditCard.nameCard ?? '';
    _fitToComeDate.text = getYmdFormat(
        DateTime.fromMillisecondsSinceEpoch(_customer!.creditCard.expiredDate));
    _cvvAndCvn.text = _customer?.creditCard.cvc ?? '';
  }
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                      child:
                          Text(S.of(context).paymentCard, style: headerStyle)),
                  ...[
                    ImageConst.visaIcon,
                    ...
                    ImageConst.cardIcon
                      ...
                      .map((e) =>
                          Image.asset(e.toString(), height: 40, width: 40))
                      .expand(
